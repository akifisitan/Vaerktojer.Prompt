...
public static class SelectOptionsExtensions
{
    ...
    public static SelectOptions<T> WithDefaultValue<T>(
        this SelectOptions<T> options,
        T defaultValue
    )
        where T : notnull
    {
    ...
    public static SelectOptions<T> WithTextSelector<T>(
        this SelectOptions<T> options,
    ...
    public static SelectOptions<T> WithPagination<T>(
        this SelectOptions<T> options,
